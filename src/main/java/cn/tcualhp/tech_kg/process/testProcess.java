 ...
 * @description spark问题模型训练
 * @create 2019/11/21 22:18
 **/
...
public class testProcess {
    ...
    public void ModelProcess() throws Exception {
    ...
    public void ModelProcess(String rootDirPath) throws Exception {
